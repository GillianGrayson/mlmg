function plot_linreg_ols(plot_data)
...
hold all;
h = plot(plot_data.line_x, plot_data.line_y_down, '-', 'LineWidth', 1, 'Color', plot_data.color);
set(get(get(h, 'Annotation'), 'LegendInformation'), 'IconDisplayStyle', 'off');

hold all;
h = plot(plot_data.line_x, plot_data.line_y_up, '-', 'LineWidth', 1, 'Color', plot_data.color);
set(get(get(h, 'Annotation'), 'LegendInformation'), 'IconDisplayStyle', 'off');
